...
const CartSidebar = () => {
  ...
  return (
    <div
      className={`fixed right-0 top-0 h-full w-96 bg-white dark:bg-gray-800 shadow-2xl z-40 flex flex-col transform transition-transform duration-300 ease-in-out ${
      ...
      {items.length > 0 && (
        <div className="border-t border-gray-200 dark:border-gray-700 px-6 py-4 bg-gray-50 dark:bg-gray-900/50">
          ...
          <button
            ...
            className="w-full bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-medium py-2.5 px-4 rounded-lg transition-colors duration-200 mb-2"
          >
            Go to basket
          </button>
          ...
          <Link
            to="/products"
            onClick={handleClose}
            className="block text-center text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 hover:underline font-medium"
          >
            Continue shopping
          </Link>
        </div>
