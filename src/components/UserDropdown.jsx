...
const UserDropdown = ({ className = '' }) => {
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-72 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden z-50 transition-all duration-200 transform origin-top-right">
          {/* User Info Header */}
          <div className="px-4 py-3 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-700 dark:to-gray-700 border-b border-gray-200 dark:border-gray-600">
          ...
          <div className="py-2">
            {menuItems.map((item, index) => (
              <Link
                ...
                className="flex items-start px-4 py-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150 group"
              >
                ...
                <div className="ml-3 flex-1">
                  <p className="font-medium group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-150">
                    {item.label}
                  </p>
                  {item.description && (
          ...
          <div className="py-2">
            <button
              ...
              className="w-full flex items-center px-4 py-3 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-150 group disabled:opacity-50 disabled:cursor-not-allowed"
            >
